...
class PrinterTest {
    ...
    void print() throws IOException, ArgumentException, ParseException {
        String[] test1 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-T"};
        ...
        String[] test2 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-T", "-S", "I"};
        ...
        String[] test3 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-T", "-S", "II"};
        ...
        String[] test4 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-A", "1"};
        ...
        String[] test5 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-N", "-A", "1", "-P", "1"};
        ...
        String[] test6 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-A", "1", "-P", "1", "-s", "1", "-c", "a-a"};
        ...
        String[] test7 = {"-F", "src" + File.separator + "test" + File.separator + "resources" + File.separator + "tto" + File.separator + "test.txt", "-A", "1", "-P", "1", "-s", "1", "-c", "b"};
